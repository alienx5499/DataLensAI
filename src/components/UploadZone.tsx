...
export function UploadZone() {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto space-y-4">
      <Card
        className="bg-white/5 backdrop-blur-md shadow-glass cursor-pointer transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 text-white/90 border-white/10"
